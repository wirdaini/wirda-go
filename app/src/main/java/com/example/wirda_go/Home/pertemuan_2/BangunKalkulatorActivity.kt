package com.example.wirda_go.Home.pertemuan_2
...
class BangunKalkulatorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bangun_kalkulator)
        ...
        btnLuas.setOnClickListener {
            if (etDiagonal1.text.toString().trim().isEmpty()
                ...
                Toast.makeText(this@BangunKalkulatorActivity, "Form tidak boleh kosong!", Toast.LENGTH_SHORT).show()
            } else {
